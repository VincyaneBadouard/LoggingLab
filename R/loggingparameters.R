...
#'  = 20, in % (double)
#'@param CableTreesMaxSlope Maximum slope around the tree to access it with cable. Default = 22,
#'  in % (double)
...
#'@param ResamplDistDTM distance of DTM resampling to erase microtopographic variation (integer).
