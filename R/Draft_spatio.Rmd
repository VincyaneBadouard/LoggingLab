...
proj4string(SpatInventory) <- raster::crs(DemParacou) # attribuer le crs de Paracou à notre inventaire spatialisé
...
proj4string(test_inventory) <- raster::crs(DemParacou)
