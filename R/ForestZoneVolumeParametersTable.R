...
#'
#' Parameters of the tree volume table used to compute the harvestable volume of
#' each tree, depending on its geographic zone
#' (Source: "Guide de Sylviculture", ONF ('Office National des Forêts') of
#' French Guiana, 2014)
#'
#' @format A tibble with 14 rows and 4 variables:
#' \describe{
