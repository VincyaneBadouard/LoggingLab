...
#'
#' @return Input inventory with a DeathCause column filled with the given
#'   deathcause
#'
#' @importFrom sf st_as_sf st_intersection st_make_valid st_union
...
mortalityunderpolygon <- function(
  ...
  if(!inherits(polygons, "MULTIPOLYGON"))
    stop("The 'polygons' argument of the 'mortalityunderpolygon' function must be a MULTIPOLYGON")

  # vérifier qu'il a un crs
