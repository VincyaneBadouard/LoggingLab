...
#'   cores = 2
#'
#' @format A large list of 38 elements for each iteration, contained in a list.
#' \describe{
...
#'   \item{TrailsDensity}{Trails density (preliminary if FWE) in m/m2 (units)}
#'   \item{AdjustTrailsDensity}{Adjusted trails density if FWE in m/m2 (units)}
#'
