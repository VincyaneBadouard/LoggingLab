...
#'
#' test <- harvestable(inventory, topography = DTMParacou,exploitpolygones = ExploitPolygones,
#' diversification = TRUE, specieslax = FALSE, plotslope = PlotSlope,maintrails = Maintrails,
