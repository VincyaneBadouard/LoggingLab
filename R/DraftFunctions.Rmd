...
RegionTreeHeight <- retrieveH(D = Paracou6_2016$DBH, region = "GuianaShield") #continent or region specific model (Feldpaush et al. (2012))
...
CoordTreeHeight <- retrieveH(D = Paracou6_2016$DBH, coord = coord) #by coordinates (Chave et al. (2012))
