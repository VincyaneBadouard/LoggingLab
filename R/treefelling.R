...
treefelling <- function(
  ...
  if(!any(unlist(lapply(list(MainTrail, ScndTrail), inherits, "MULTIPOLYGON"))))
    stop("The 'MainTrail' and 'ScndTrail' arguments of the 'treefelling' function must be MULTIPOLYGON")
...
successfail <- function(
  ...
  if (!any(fuel == "0" | fuel == "1"| fuel == "2"| is.null(fuel)))
    stop("The 'fuel' argument of the 'successfail' function must be '0', '1', or '2'")

  if (!any(directionalfelling == "0" | directionalfelling == "1"| directionalfelling == "2"| is.null(directionalfelling)))
    stop("The 'directionalfelling' argument of the 'successfail' function must be '0', '1', or '2'")
...
st_tree <- function(
  ...
  if(!any(unlist(lapply(list(MainTrail, ScndTrail), inherits, "MULTIPOLYGON"))))
    stop("The 'MainTrail' and 'ScndTrail' arguments of the 'st_tree' function must be MULTIPOLYGON")

  if (!any(fuel == "0" | fuel == "1"| fuel == "2"| is.null(fuel)))
    stop("The 'fuel' argument of the 'st_tree' function must be '0', '1', or '2'")

  if (!any(directionalfelling == "0" | directionalfelling == "1"| directionalfelling == "2"| is.null(directionalfelling)))
    stop("The 'directionalfelling' argument of the 'st_tree' function must be '0', '1', or '2'")
