...
if (is.null(secondtrailsRIL2broken$paths) == FALSE) {
  secondtrailsRIL2broken$lines
  plot(st_as_sf(secondtrailsRIL2broken$paths))
...
if (is.null(secondtrailsRIL2$paths) == FALSE) {
  secondtrailsRIL2$lines
  plot(st_as_sf(secondtrailsRIL2$paths))
