...
Harvestableoutputs <- harvestableareadefinition(topography = DTMParacou,
                                                 creekdistances = CreekDistances,
                                                 plotmask = PlotMask,
                                                 scenario = "RIL2broken")
HarvestablePolygons <- Harvestableoutputs$HarvestablePolygons
  
PlotSlope <- Harvestableoutputs$PlotSlope
...
if (is.null(secondtrailsRIL2broken$RawSecondTrails) == FALSE) {
  secondtrailsRIL2broken$TrailsIdentity
  plot(st_as_sf(secondtrailsRIL2broken$RawSecondTrails))
  plot(st_as_sf(secondtrailsRIL2broken$SmoothedSecondTrails))
  raster::plot(secondtrailsRIL2broken$CostRasterAgg)
  plot(st_as_sf(secondtrailsRIL2broken$SmoothedSecondTrails),add=T)
}else{
  secondtrailsRIL2broken$TrailsIdentity
}
```
...
if (is.null(secondtrailsRIL2$RawSecondTrails) == FALSE) {
  secondtrailsRIL2$TrailsIdentity
  plot(st_as_sf(secondtrailsRIL2$RawSecondTrails))
  plot(st_as_sf(secondtrailsRIL2$SmoothedSecondTrails))
  raster::plot(secondtrailsRIL2$CostRasterAgg)
  plot(st_as_sf(secondtrailsRIL2$SmoothedSecondTrails),add=T)
}else{
  secondtrailsRIL2$TrailsIdentity
}
...
if (is.null(secondtrailsRIL3$paths) == FALSE) {
  secondtrailsRIL3$lines
  plot(st_as_sf(secondtrailsRIL3$paths))
  plot(st_as_sf(secondtrailsRIL3$SmoothedSecondTrails))
  raster::plot(secondtrailsRIL3$CostRasterAgg)
  plot(st_as_sf(secondtrailsRIL3$SmoothedSecondTrails),add=T)
}else{
  secondtrailsRIL3$lines
}
...
if (is.null(secondtrailsRIL3fuel$paths) == FALSE) {
  secondtrailsRIL3fuel$lines
  plot(st_as_sf(secondtrailsRIL3fuel$paths))
  plot(st_as_sf(secondtrailsRIL3fuel$SmoothedSecondTrails))
  raster::plot(secondtrailsRIL3fuel$CostRasterAgg)
  plot(st_as_sf(secondtrailsRIL3fuel$SmoothedSecondTrails),add=T)
}else{
  secondtrailsRIL3fuel$lines
}
```
...
if (is.null(secondtrailsRIL3fuelhollow$paths) == FALSE) {
  secondtrailsRIL3fuelhollow$lines
  plot(st_as_sf(secondtrailsRIL3fuelhollow$paths))
  plot(st_as_sf(secondtrailsRIL3fuelhollow$SmoothedSecondTrails))
  raster::plot(secondtrailsRIL3fuelhollow$CostRasterAgg)
  plot(st_as_sf(secondtrailsRIL3fuelhollow$SmoothedSecondTrails),add=T)
}else{
  secondtrailsRIL3fuelhollow$lines
}
```
...
HADP16<- LoggingLab::HarvestableAreaDefinition(topography = DemParacou,creekdistances = HANDParacou16)
...
treeselectionoutputsP16RIL2broken<- LoggingLab::treeselection(inventory,
...
secondtrailsP16RIL2broken <- LoggingLab::secondtrailsopening(topography = DemParacou, plotmask = Parcelle,
...
treeselectionoutputsP16RIL2<- LoggingLab::treeselection(inventory,
                                                       topography = DemParacou, plotslope = plotslopeP16, MainTrails = MainTrailsP16,
                                                       harvestablepolygons = harvestablepolygonsP16,
                                                       speciescriteria = SpeciesCriteria, objective = scenarios$objective,
                                                       scenario ="RIL2",
...
treeselectionoutputsP16RIL3<- LoggingLab::treeselection(inventory,
                                                       topography = DemParacou, plotslope = plotslopeP16, MainTrails = MainTrailsP16,
                                                       harvestablepolygons = harvestablepolygonsP16,
                                                       speciescriteria = SpeciesCriteria, objective = scenarios$objective,
                                                       scenario ="RIL3",
...
secondtrailsP16RIL3 <- LoggingLab::secondtrailsopening(topography = DemParacou, plotmask = Parcelle,
...
treeselectionoutputsP16RIL3fuel<- LoggingLab::treeselection(inventory,
                                                       topography = DemParacou, plotslope = plotslopeP16, MainTrails = MainTrailsP16,
                                                       harvestablepolygons = harvestablepolygonsP16,
                                                       speciescriteria = SpeciesCriteria, objective = scenarios$objective,
                                                       scenario ="RIL3fuel",
...
secondtrailsP16RIL3fuel <- LoggingLab::secondtrailsopening(topography = DemParacou, plotmask = Parcelle,
...
treeselectionoutputsP16RIL3fuelhollow<- LoggingLab::treeselection(inventory,
                                                       topography = DemParacou, plotslope = plotslopeP16, MainTrails = MainTrailsP16,
                                                       harvestablepolygons = harvestablepolygonsP16,
                                                       speciescriteria = SpeciesCriteria, objective = scenarios$objective,
                                                       scenario ="RIL3fuelhollow",
...
secondtrailsP16RIL3fuelhollow <- LoggingLab::secondtrailsopening(topography = DemParacou, plotmask = Parcelle,
