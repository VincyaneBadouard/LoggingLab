...
secondtrails$RawSecondTrails # 'RawSecondTrails'
class(secondtrails$RawSecondTrails) # SpatialTrailsIdentity (sp)
plot(st_as_sf(secondtrails$RawSecondTrails))

secondtrails$TrailsIdentity # 'TrailsIdentity' Sert à quoi ??
