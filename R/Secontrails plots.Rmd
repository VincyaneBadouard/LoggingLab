...
secondtrails[[1]] # 'paths'
class(secondtrails[[1]]) # SpatialLines (sp)

secondtrails[[2]] # 'lines' Sert à quoi ??
class(secondtrails[[2]]) # matrix

plot(secondtrails[[3]]) # SmoothedSecondTrails
class(secondtrails[[3]]) # sfc_MULTIPOLYGON

secondtrails[[4]] # TrailsDensity
class(secondtrails[[4]]) # "units" ??? A mettre en numeric !

new_inventory <- secondtrails[[5]] # inventory
class(secondtrails[[5]]) # data.frame

secondtrails[[6]] # CostRasterMean. Sert à quoi ??
class(secondtrails[[6]]) # RasterLayer
