...
or SRTM) (RasterLayer  **with a crs in UTM**)

+ **creekdistances** Relative (vertical and horizontal) distances from nearest channel network
(list of 2 large RasterLayers **with a crs in UTM**)
