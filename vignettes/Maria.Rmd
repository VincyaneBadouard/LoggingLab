...
+ **Purge (unused part of the log)** = 0.14 m^3 of fuelwood/m^3 of logged trees
...
'createcanopy' function return an ellipse (*sfc_POLYGON*) as a crown, with its diameter and height filled in, representing the tree from the sky.
```{r}
dat <- inventory[679,]
