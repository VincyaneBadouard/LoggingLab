test_that("harvestableareadefinition",{
  ...
  expect_s3_class(test_HarvestablePolygons0, class = 'sf')
  expect_s3_class(test_HarvestablePolygons1, class = 'sf')
  expect_s3_class(test_HarvestablePolygons2, class = 'sf')
